  ...
  return (
    ...
    <>
      ...
      <div className="max-w-screen-xl flex-wrap items-center mx-auto p-4 flex justify-center mt-10">
        <h1 className="mb-4 mt-4 text-3xl font-extrabold text-black dark:text-black md:text-5xl lg:text-5xl ">Welcome to <span className="text-transparent bg-clip-text bg-green-600">Quiz Fest</span></h1>
      </div>
      <div className="max-w-screen-xl flex-wrap items-center mx-auto p-4 flex justify-center ">
        <div className="p-10 my-10 rounded-lg shadow-xl w-[65%] bg-white">
          <div className="pt-5 bg-white">
            <Input placeholder="number of questions" className="mt-5 " type="number" defaultValue={10} min={0} max={15} onChange={(e) => addNumberOfQuestions(parseInt(e.target.value))} />
          </div>
